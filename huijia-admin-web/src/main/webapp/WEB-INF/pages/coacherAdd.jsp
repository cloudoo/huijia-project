                                ...
                                <div class="widget flat radius-bordered">
                                    ...
                                    <div class="widget-body">
                                        <div id="registration-form">
                                            <form class = "form-horizontal" role="form" id= "addForm" action="save.hj" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <span class="input-icon icon-right">
                                                                            <input type="text" id = "cellphoneInput" name ="cellphone" class="form-control" placeholder="Phone" value="${coacherInfo.cellphone}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <span class="input-icon icon-right">
                                                                            <input type="text" name ="techage" class="form-control" placeholder="请输入数字" value="${coacherInfo.techage}">
                                                                            <%--<i class="glyphicon glyphicon-earphone"></i>--%>
                                                                        </span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="from-group" >
                                                    <input type="hidden" name="description" class="form-control"  rows="1" value="${coacherInfo.description}" />
...
<script src="<c:url value='../assets/hj/coacherAdd.js'/> "/>
<script>
